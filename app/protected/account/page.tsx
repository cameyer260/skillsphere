...
export default function Account() {
	...
	const [editFavGamesOverlay, setEditFavGamesOverlay] =
		useState<boolean>(false);
	const [editPictureOverlay, setEditPictureOverlay] =
		useState<boolean>(false);
	...
	const handleUsernameSubmit = () => {console.log(newUsername)};
	const handleGamesSubmit = () => {console.log(clickedGames)};
  const handlePictureSubmit = () => {console.log("hi")}
		...
		<div className="min-h-screen px-4">
			<div className="flex flex-row gap-4 border-b border-b-foreground/30 w-full justify-evenly p-4">
				...
				<div className="flex flex-col gap-2 justify-center p-4">
					...
					<div className="flex flex-row gap-2">
						<p>
							His favorite games are chess, pong, and tic-tac-toe
						</p>
						<button
							onClick={() => {
									...
									>
										...
										>
											<Image
												...
												alt="game-icon"
											/>
											<h1 className="text-center text-xl pb-1">
												{game}
											</h1>
										</button>
									</div>
